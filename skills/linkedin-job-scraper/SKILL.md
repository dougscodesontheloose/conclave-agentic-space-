...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: linkedin-job-scraper — [finding]` | `[OPERACIONAL]: linkedin-job-scraper — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: linkedin-job-scraper — [param] works better as [value]` | `[OPERACIONAL]: linkedin-job-scraper — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: linkedin-job-scraper — [insight]` | `[ESTRATÉGICO]: linkedin-job-scraper — Competitor X has no case studies page, vulnerability for battlecard` |
