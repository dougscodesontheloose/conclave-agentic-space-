...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: pipeline-review — [finding]` | `[OPERACIONAL]: pipeline-review — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: pipeline-review — [param] works better as [value]` | `[OPERACIONAL]: pipeline-review — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: pipeline-review — [insight]` | `[ESTRATÉGICO]: pipeline-review — Competitor X has no case studies page, vulnerability for battlecard` |
