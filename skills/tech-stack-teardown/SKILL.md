...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: tech-stack-teardown — [finding]` | `[OPERACIONAL]: tech-stack-teardown — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: tech-stack-teardown — [param] works better as [value]` | `[OPERACIONAL]: tech-stack-teardown — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: tech-stack-teardown — [insight]` | `[ESTRATÉGICO]: tech-stack-teardown — Competitor X has no case studies page, vulnerability for battlecard` |
