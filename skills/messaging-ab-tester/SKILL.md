...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: messaging-ab-tester — [finding]` | `[OPERACIONAL]: messaging-ab-tester — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: messaging-ab-tester — [param] works better as [value]` | `[OPERACIONAL]: messaging-ab-tester — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: messaging-ab-tester — [insight]` | `[ESTRATÉGICO]: messaging-ab-tester — Competitor X has no case studies page, vulnerability for battlecard` |
