...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: inbound-lead-enrichment — [finding]` | `[OPERACIONAL]: inbound-lead-enrichment — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: inbound-lead-enrichment — [param] works better as [value]` | `[OPERACIONAL]: inbound-lead-enrichment — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: inbound-lead-enrichment — [insight]` | `[ESTRATÉGICO]: inbound-lead-enrichment — Competitor X has no case studies page, vulnerability for battlecard` |
