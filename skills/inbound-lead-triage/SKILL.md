...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: inbound-lead-triage — [finding]` | `[OPERACIONAL]: inbound-lead-triage — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: inbound-lead-triage — [param] works better as [value]` | `[OPERACIONAL]: inbound-lead-triage — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: inbound-lead-triage — [insight]` | `[ESTRATÉGICO]: inbound-lead-triage — Competitor X has no case studies page, vulnerability for battlecard` |
