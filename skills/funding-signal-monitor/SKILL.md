...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: funding-signal-monitor — [finding]` | `[OPERACIONAL]: funding-signal-monitor — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: funding-signal-monitor — [param] works better as [value]` | `[OPERACIONAL]: funding-signal-monitor — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: funding-signal-monitor — [insight]` | `[ESTRATÉGICO]: funding-signal-monitor — Competitor X has no case studies page, vulnerability for battlecard` |
