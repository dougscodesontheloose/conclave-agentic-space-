...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: feature-launch-playbook — [finding]` | `[OPERACIONAL]: feature-launch-playbook — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: feature-launch-playbook — [param] works better as [value]` | `[OPERACIONAL]: feature-launch-playbook — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: feature-launch-playbook — [insight]` | `[ESTRATÉGICO]: feature-launch-playbook — Competitor X has no case studies page, vulnerability for battlecard` |
