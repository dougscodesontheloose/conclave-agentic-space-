...
tags: [lead-generation, events, signals]
---
...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: lead-gen-devtools/event-signals — [finding]` | `[OPERACIONAL]: lead-gen-devtools/event-signals — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: lead-gen-devtools/event-signals — [param] works better as [value]` | `[OPERACIONAL]: lead-gen-devtools/event-signals — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: lead-gen-devtools/event-signals — [insight]` | `[ESTRATÉGICO]: lead-gen-devtools/event-signals — Competitor X has no case studies page, vulnerability for battlecard` |
