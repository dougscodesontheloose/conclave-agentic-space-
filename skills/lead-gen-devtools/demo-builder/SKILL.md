...
tags: [outreach, content, development]
---
...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: lead-gen-devtools/demo-builder — [finding]` | `[OPERACIONAL]: lead-gen-devtools/demo-builder — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: lead-gen-devtools/demo-builder — [param] works better as [value]` | `[OPERACIONAL]: lead-gen-devtools/demo-builder — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: lead-gen-devtools/demo-builder — [insight]` | `[ESTRATÉGICO]: lead-gen-devtools/demo-builder — Competitor X has no case studies page, vulnerability for battlecard` |
