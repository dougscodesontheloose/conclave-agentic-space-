...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: funding-signal-outreach — [finding]` | `[OPERACIONAL]: funding-signal-outreach — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: funding-signal-outreach — [param] works better as [value]` | `[OPERACIONAL]: funding-signal-outreach — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: funding-signal-outreach — [insight]` | `[ESTRATÉGICO]: funding-signal-outreach — Competitor X has no case studies page, vulnerability for battlecard` |
