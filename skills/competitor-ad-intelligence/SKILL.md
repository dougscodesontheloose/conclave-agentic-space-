...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: competitor-ad-intelligence — [finding]` | `[OPERACIONAL]: competitor-ad-intelligence — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: competitor-ad-intelligence — [param] works better as [value]` | `[OPERACIONAL]: competitor-ad-intelligence — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: competitor-ad-intelligence — [insight]` | `[ESTRATÉGICO]: competitor-ad-intelligence — Competitor X has no case studies page, vulnerability for battlecard` |
