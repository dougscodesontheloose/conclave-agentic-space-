...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: linkedin-message-writer — [finding]` | `[OPERACIONAL]: linkedin-message-writer — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: linkedin-message-writer — [param] works better as [value]` | `[OPERACIONAL]: linkedin-message-writer — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: linkedin-message-writer — [insight]` | `[ESTRATÉGICO]: linkedin-message-writer — Competitor X has no case studies page, vulnerability for battlecard` |
