...
description: >
  ...
  or prospect.
tags: [research, competitive-intel, strategy]
---
...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: company-current-gtm-analysis — [finding]` | `[OPERACIONAL]: company-current-gtm-analysis — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: company-current-gtm-analysis — [param] works better as [value]` | `[OPERACIONAL]: company-current-gtm-analysis — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: company-current-gtm-analysis — [insight]` | `[ESTRATÉGICO]: company-current-gtm-analysis — Competitor X has no case studies page, vulnerability for battlecard` |
