...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: news-signal-outreach — [finding]` | `[OPERACIONAL]: news-signal-outreach — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: news-signal-outreach — [param] works better as [value]` | `[OPERACIONAL]: news-signal-outreach — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: news-signal-outreach — [insight]` | `[ESTRATÉGICO]: news-signal-outreach — Competitor X has no case studies page, vulnerability for battlecard` |
