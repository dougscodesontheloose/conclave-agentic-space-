...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: cold-email-outreach — [finding]` | `[OPERACIONAL]: cold-email-outreach — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: cold-email-outreach — [param] works better as [value]` | `[OPERACIONAL]: cold-email-outreach — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: cold-email-outreach — [insight]` | `[ESTRATÉGICO]: cold-email-outreach — Competitor X has no case studies page, vulnerability for battlecard` |
