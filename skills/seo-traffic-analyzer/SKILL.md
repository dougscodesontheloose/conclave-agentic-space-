...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: seo-traffic-analyzer — [finding]` | `[OPERACIONAL]: seo-traffic-analyzer — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: seo-traffic-analyzer — [param] works better as [value]` | `[OPERACIONAL]: seo-traffic-analyzer — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: seo-traffic-analyzer — [insight]` | `[ESTRATÉGICO]: seo-traffic-analyzer — Competitor X has no case studies page, vulnerability for battlecard` |
