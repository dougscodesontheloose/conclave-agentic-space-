...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: champion-move-outreach — [finding]` | `[OPERACIONAL]: champion-move-outreach — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: champion-move-outreach — [param] works better as [value]` | `[OPERACIONAL]: champion-move-outreach — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: champion-move-outreach — [insight]` | `[ESTRATÉGICO]: champion-move-outreach — Competitor X has no case studies page, vulnerability for battlecard` |
