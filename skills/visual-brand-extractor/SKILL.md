...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: visual-brand-extractor — [finding]` | `[OPERACIONAL]: visual-brand-extractor — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: visual-brand-extractor — [param] works better as [value]` | `[OPERACIONAL]: visual-brand-extractor — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: visual-brand-extractor — [insight]` | `[ESTRATÉGICO]: visual-brand-extractor — Competitor X has no case studies page, vulnerability for battlecard` |
