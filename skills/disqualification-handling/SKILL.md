...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: disqualification-handling — [finding]` | `[OPERACIONAL]: disqualification-handling — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: disqualification-handling — [param] works better as [value]` | `[OPERACIONAL]: disqualification-handling — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: disqualification-handling — [insight]` | `[ESTRATÉGICO]: disqualification-handling — Competitor X has no case studies page, vulnerability for battlecard` |
