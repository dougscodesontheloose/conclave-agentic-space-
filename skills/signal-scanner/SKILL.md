...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: signal-scanner — [finding]` | `[OPERACIONAL]: signal-scanner — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: signal-scanner — [param] works better as [value]` | `[OPERACIONAL]: signal-scanner — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: signal-scanner — [insight]` | `[ESTRATÉGICO]: signal-scanner — Competitor X has no case studies page, vulnerability for battlecard` |
