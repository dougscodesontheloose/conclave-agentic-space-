...
tags: [content, design, presentations]
---
...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: create-html-slides — [finding]` | `[OPERACIONAL]: create-html-slides — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: create-html-slides — [param] works better as [value]` | `[OPERACIONAL]: create-html-slides — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: create-html-slides — [insight]` | `[ESTRATÉGICO]: create-html-slides — Competitor X has no case studies page, vulnerability for battlecard` |
