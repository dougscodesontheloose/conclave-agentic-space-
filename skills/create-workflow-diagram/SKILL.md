...
tags: [content, design, visualization]
---
...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: create-workflow-diagram — [finding]` | `[OPERACIONAL]: create-workflow-diagram — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: create-workflow-diagram — [param] works better as [value]` | `[OPERACIONAL]: create-workflow-diagram — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: create-workflow-diagram — [insight]` | `[ESTRATÉGICO]: create-workflow-diagram — Competitor X has no case studies page, vulnerability for battlecard` |
