...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: ad-campaign-analyzer — [finding]` | `[OPERACIONAL]: ad-campaign-analyzer — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: ad-campaign-analyzer — [param] works better as [value]` | `[OPERACIONAL]: ad-campaign-analyzer — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: ad-campaign-analyzer — [insight]` | `[ESTRATÉGICO]: ad-campaign-analyzer — Competitor X has no case studies page, vulnerability for battlecard` |
