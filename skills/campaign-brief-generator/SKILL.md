...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: campaign-brief-generator — [finding]` | `[OPERACIONAL]: campaign-brief-generator — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: campaign-brief-generator — [param] works better as [value]` | `[OPERACIONAL]: campaign-brief-generator — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: campaign-brief-generator — [insight]` | `[ESTRATÉGICO]: campaign-brief-generator — Competitor X has no case studies page, vulnerability for battlecard` |
