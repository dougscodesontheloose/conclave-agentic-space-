...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: hiring-signal-outreach — [finding]` | `[OPERACIONAL]: hiring-signal-outreach — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: hiring-signal-outreach — [param] works better as [value]` | `[OPERACIONAL]: hiring-signal-outreach — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: hiring-signal-outreach — [insight]` | `[ESTRATÉGICO]: hiring-signal-outreach — Competitor X has no case studies page, vulnerability for battlecard` |
