...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: sales-coaching — [finding]` | `[OPERACIONAL]: sales-coaching — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: sales-coaching — [param] works better as [value]` | `[OPERACIONAL]: sales-coaching — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: sales-coaching — [insight]` | `[ESTRATÉGICO]: sales-coaching — Competitor X has no case studies page, vulnerability for battlecard` |
