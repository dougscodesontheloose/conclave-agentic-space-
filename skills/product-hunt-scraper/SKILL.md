...
tags: [scraping, monitoring, competitive-intel]
---
...
Use `product-hunt-scraper` when you need to:
...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: product-hunt-scraper — [finding]` | `[OPERACIONAL]: product-hunt-scraper — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: product-hunt-scraper — [param] works better as [value]` | `[OPERACIONAL]: product-hunt-scraper — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: product-hunt-scraper — [insight]` | `[ESTRATÉGICO]: product-hunt-scraper — Competitor X has no case studies page, vulnerability for battlecard` |
