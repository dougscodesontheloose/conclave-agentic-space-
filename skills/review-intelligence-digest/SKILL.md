...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: review-intelligence-digest — [finding]` | `[OPERACIONAL]: review-intelligence-digest — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: review-intelligence-digest — [param] works better as [value]` | `[OPERACIONAL]: review-intelligence-digest — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: review-intelligence-digest — [insight]` | `[ESTRATÉGICO]: review-intelligence-digest — Competitor X has no case studies page, vulnerability for battlecard` |
