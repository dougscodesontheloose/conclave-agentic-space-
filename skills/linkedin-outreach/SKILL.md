...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: linkedin-outreach — [finding]` | `[OPERACIONAL]: linkedin-outreach — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: linkedin-outreach — [param] works better as [value]` | `[OPERACIONAL]: linkedin-outreach — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: linkedin-outreach — [insight]` | `[ESTRATÉGICO]: linkedin-outreach — Competitor X has no case studies page, vulnerability for battlecard` |
