...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: inbound-lead-qualification — [finding]` | `[OPERACIONAL]: inbound-lead-qualification — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: inbound-lead-qualification — [param] works better as [value]` | `[OPERACIONAL]: inbound-lead-qualification — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: inbound-lead-qualification — [insight]` | `[ESTRATÉGICO]: inbound-lead-qualification — Competitor X has no case studies page, vulnerability for battlecard` |
