...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: paid-channel-prioritizer — [finding]` | `[OPERACIONAL]: paid-channel-prioritizer — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: paid-channel-prioritizer — [param] works better as [value]` | `[OPERACIONAL]: paid-channel-prioritizer — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: paid-channel-prioritizer — [insight]` | `[ESTRATÉGICO]: paid-channel-prioritizer — Competitor X has no case studies page, vulnerability for battlecard` |
