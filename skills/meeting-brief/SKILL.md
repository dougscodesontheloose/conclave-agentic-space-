...
tags: [research, automation, outreach]
---
...
Use `meeting-brief` when you need to:
- Engage prospects with personalized messaging
- Execute a multi-touch outreach sequence
- Convert qualified leads into conversations
