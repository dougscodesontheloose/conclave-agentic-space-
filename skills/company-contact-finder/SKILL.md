...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: company-contact-finder — [finding]` | `[OPERACIONAL]: company-contact-finder — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: company-contact-finder — [param] works better as [value]` | `[OPERACIONAL]: company-contact-finder — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: company-contact-finder — [insight]` | `[ESTRATÉGICO]: company-contact-finder — Competitor X has no case studies page, vulnerability for battlecard` |
