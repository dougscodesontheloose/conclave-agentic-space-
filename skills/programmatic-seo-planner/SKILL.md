...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: programmatic-seo-planner — [finding]` | `[OPERACIONAL]: programmatic-seo-planner — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: programmatic-seo-planner — [param] works better as [value]` | `[OPERACIONAL]: programmatic-seo-planner — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: programmatic-seo-planner — [insight]` | `[ESTRATÉGICO]: programmatic-seo-planner — Competitor X has no case studies page, vulnerability for battlecard` |
