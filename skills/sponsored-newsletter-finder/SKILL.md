...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: sponsored-newsletter-finder — [finding]` | `[OPERACIONAL]: sponsored-newsletter-finder — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: sponsored-newsletter-finder — [param] works better as [value]` | `[OPERACIONAL]: sponsored-newsletter-finder — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: sponsored-newsletter-finder — [insight]` | `[ESTRATÉGICO]: sponsored-newsletter-finder — Competitor X has no case studies page, vulnerability for battlecard` |
