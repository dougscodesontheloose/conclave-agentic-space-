...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: sequence-performance — [finding]` | `[OPERACIONAL]: sequence-performance — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: sequence-performance — [param] works better as [value]` | `[OPERACIONAL]: sequence-performance — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: sequence-performance — [insight]` | `[ESTRATÉGICO]: sequence-performance — Competitor X has no case studies page, vulnerability for battlecard` |
