...
tags: [lead-generation, qualification, enrichment]
---
...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: lead-qualification — [finding]` | `[OPERACIONAL]: lead-qualification — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: lead-qualification — [param] works better as [value]` | `[OPERACIONAL]: lead-qualification — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: lead-qualification — [insight]` | `[ESTRATÉGICO]: lead-qualification — Competitor X has no case studies page, vulnerability for battlecard` |
