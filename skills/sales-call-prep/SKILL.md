...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: sales-call-prep — [finding]` | `[OPERACIONAL]: sales-call-prep — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: sales-call-prep — [param] works better as [value]` | `[OPERACIONAL]: sales-call-prep — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: sales-call-prep — [insight]` | `[ESTRATÉGICO]: sales-call-prep — Competitor X has no case studies page, vulnerability for battlecard` |
