...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: icp-identification — [finding]` | `[OPERACIONAL]: icp-identification — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: icp-identification — [param] works better as [value]` | `[OPERACIONAL]: icp-identification — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: icp-identification — [insight]` | `[ESTRATÉGICO]: icp-identification — Competitor X has no case studies page, vulnerability for battlecard` |
