...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: get-qualified-leads-from-luma — [finding]` | `[OPERACIONAL]: get-qualified-leads-from-luma — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: get-qualified-leads-from-luma — [param] works better as [value]` | `[OPERACIONAL]: get-qualified-leads-from-luma — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: get-qualified-leads-from-luma — [insight]` | `[ESTRATÉGICO]: get-qualified-leads-from-luma — Competitor X has no case studies page, vulnerability for battlecard` |
