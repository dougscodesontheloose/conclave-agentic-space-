...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: leadership-change-outreach — [finding]` | `[OPERACIONAL]: leadership-change-outreach — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: leadership-change-outreach — [param] works better as [value]` | `[OPERACIONAL]: leadership-change-outreach — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: leadership-change-outreach — [insight]` | `[ESTRATÉGICO]: leadership-change-outreach — Competitor X has no case studies page, vulnerability for battlecard` |
