...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: buyer-persona-generator — [finding]` | `[OPERACIONAL]: buyer-persona-generator — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: buyer-persona-generator — [param] works better as [value]` | `[OPERACIONAL]: buyer-persona-generator — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: buyer-persona-generator — [insight]` | `[ESTRATÉGICO]: buyer-persona-generator — Competitor X has no case studies page, vulnerability for battlecard` |
