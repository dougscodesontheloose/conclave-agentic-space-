...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: content-brief-factory — [finding]` | `[OPERACIONAL]: content-brief-factory — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: content-brief-factory — [param] works better as [value]` | `[OPERACIONAL]: content-brief-factory — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: content-brief-factory — [insight]` | `[ESTRATÉGICO]: content-brief-factory — Competitor X has no case studies page, vulnerability for battlecard` |
