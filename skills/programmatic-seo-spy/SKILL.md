...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: programmatic-seo-spy — [finding]` | `[OPERACIONAL]: programmatic-seo-spy — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: programmatic-seo-spy — [param] works better as [value]` | `[OPERACIONAL]: programmatic-seo-spy — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: programmatic-seo-spy — [insight]` | `[ESTRATÉGICO]: programmatic-seo-spy — Competitor X has no case studies page, vulnerability for battlecard` |
