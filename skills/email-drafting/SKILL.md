...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: email-drafting — [finding]` | `[OPERACIONAL]: email-drafting — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: email-drafting — [param] works better as [value]` | `[OPERACIONAL]: email-drafting — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: email-drafting — [insight]` | `[ESTRATÉGICO]: email-drafting — Competitor X has no case studies page, vulnerability for battlecard` |
