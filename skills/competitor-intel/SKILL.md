...
description_pt-BR: >
  Framework de pesquisa competitiva estruturada. Dado um concorrente (nome ou URL), produz um perfil competitivo completo: posicionamento, mensagens, produto, preço, estratégia de conteúdo e diferenciais.
type: playbook
---
...
**Auto-trigger:** Ative quando o usuário menciona competidores nomeados, pede análise de landscape, ou solicita perfil competitivo de empresa específica.
...
Nenhuma obrigatória. `WebSearch` + `WebFetch` cobrem o baseline. Apify opcional para Reddit/Twitter/LinkedIn.

## Inputs

| Input | Required | Description |
| --- | --- | --- |
| **Lista de competidores** | Yes | 2-5 nomes + URLs |
| **Contexto da sua empresa** | Yes | O que vende, ICP, posicionamento atual |
| **Áreas de foco** | Recommended | Pricing, conteúdo, produto, mensagem, hiring |
| **Profundidade** | No | `quick` (30min) ou `deep` — default: deep |
...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: competitor-intel — [finding]` | `[OPERACIONAL]: competitor-intel — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: competitor-intel — [param] works better as [value]` | `[OPERACIONAL]: competitor-intel — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: competitor-intel — [insight]` | `[ESTRATÉGICO]: competitor-intel — Competitor X has no case studies page, vulnerability for battlecard` |
