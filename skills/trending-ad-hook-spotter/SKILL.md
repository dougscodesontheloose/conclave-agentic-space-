...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: trending-ad-hook-spotter — [finding]` | `[OPERACIONAL]: trending-ad-hook-spotter — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: trending-ad-hook-spotter — [param] works better as [value]` | `[OPERACIONAL]: trending-ad-hook-spotter — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: trending-ad-hook-spotter — [insight]` | `[ESTRATÉGICO]: trending-ad-hook-spotter — Competitor X has no case studies page, vulnerability for battlecard` |
