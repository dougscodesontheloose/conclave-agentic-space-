...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: help-center-article-generator — [finding]` | `[OPERACIONAL]: help-center-article-generator — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: help-center-article-generator — [param] works better as [value]` | `[OPERACIONAL]: help-center-article-generator — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: help-center-article-generator — [insight]` | `[ESTRATÉGICO]: help-center-article-generator — Competitor X has no case studies page, vulnerability for battlecard` |
