...
tags: [scraping, linkedin, monitoring]
---
...
Use `linkedin-profile-post-scraper` when you need to:
...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: linkedin-profile-post-scraper — [finding]` | `[OPERACIONAL]: linkedin-profile-post-scraper — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: linkedin-profile-post-scraper — [param] works better as [value]` | `[OPERACIONAL]: linkedin-profile-post-scraper — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: linkedin-profile-post-scraper — [insight]` | `[ESTRATÉGICO]: linkedin-profile-post-scraper — Competitor X has no case studies page, vulnerability for battlecard` |
