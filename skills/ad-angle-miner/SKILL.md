...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: ad-angle-miner — [finding]` | `[OPERACIONAL]: ad-angle-miner — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: ad-angle-miner — [param] works better as [value]` | `[OPERACIONAL]: ad-angle-miner — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: ad-angle-miner — [insight]` | `[ESTRATÉGICO]: ad-angle-miner — Competitor X has no case studies page, vulnerability for battlecard` |
