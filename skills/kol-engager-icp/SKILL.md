...
|---|---|---|
| **Key findings** | `[OPERACIONAL]: kol-engager-icp — [finding]` | `[OPERACIONAL]: kol-engager-icp — Apify scraper returned 0 results for domain X, switched to direct mode` |
| **Parameter tuning** | `[OPERACIONAL]: kol-engager-icp — [param] works better as [value]` | `[OPERACIONAL]: kol-engager-icp — --max-results 50 is optimal for G2 (beyond 50 = mostly duplicates)` |
| **Strategic insights** | `[ESTRATÉGICO]: kol-engager-icp — [insight]` | `[ESTRATÉGICO]: kol-engager-icp — Competitor X has no case studies page, vulnerability for battlecard` |
