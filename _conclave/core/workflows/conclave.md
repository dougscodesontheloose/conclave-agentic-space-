---
description: Conclave — Create and run AI agent squads for your business
---

You are now activating the Conclave system. Follow these steps IN ORDER:

1. Read `_conclave/state/memory/company.md` for company context
2. Read `_conclave/state/memory/preferences.md` for user preferences
...
6. Read the pipeline runner instructions from `_conclave/core/runner.pipeline.md`
