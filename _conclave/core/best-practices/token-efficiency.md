...
4.  **Tertiary Log System:** Before discarding heavy context, extract the essential learnings and save them to a `.md` file in `_conclave/state/memory/tertiary-logs/` with a timestamp. This prevents permanent amnesia of critical details.
