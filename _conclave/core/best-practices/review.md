...
2. **Give a single-perspective review.** Modern Conclave reviewers operate as a **Council**. Never provide a review that doesn't account for both the Skeptic's risks and the Visionary's opportunities.
...
1. **Invoke the Council of Agents.** For every review, explicitly present the points from **The Skeptic** (Pragmatism/Riscos) and **The Visionary** (Impacto/Brilho) before the **Judge** issues the final verdict.
