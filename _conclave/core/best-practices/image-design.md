...
6. **Batch consistency and The Rule of 3 Variations for Carousels.** When creating carousels or multi-slide content, generate one HTML file per slide. Slide numbering uses zero-padded format: slide-01.html, slide-02.html. Crucially, regardless of the number of slides, the carousel must have EXACTLY 3 major design variations (as defined in `_conclave/core/carousel-master-design.md`):
   - **Slide 1 (Cover):** Very engaging, sexy, maximum visual weight.
   - **Slides 2 to N-1 (Content/Core):** Consistent standard design philosophy to deliver the message fluidly.
   - **Slide N (Back Cover/CTA):** More engaging than the content slides, but less than the cover. Contains the final hook or CTA.
