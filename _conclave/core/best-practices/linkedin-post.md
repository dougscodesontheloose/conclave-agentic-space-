...
- **The Rule of 3 Variations:** All carousels must strictly follow the 3 major design variations defined in `_conclave/core/carousel-master-design.md` (Slide 1 Cover, Content Slides, Final Slide CTA).
- **Slide 1 (Cover):** Hook slide with a bold statement or question. Highest visual weight.
- **Content Slides:** 10-15 slides with one idea per slide, 20-30 words maximum. Clean, readable, standard consistent design with large text and minimal clutter.
- **Final Slide (CTA):** CTA on the final slide directing comments, shares, or follows. Slightly more engaging than content slides, but less than the cover.
