...
- `_conclave/state/memory/` — Persistent memory (company context, preferences)
...
- `_conclave/state/browser_profile/` — Persistent browser sessions (login cookies, localStorage)
