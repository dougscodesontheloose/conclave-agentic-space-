...
Run from the Conclave project root: python3 _conclave/tools/scripts/validate_conclave.py
"""
...
def check_core(root, r):
    ...
    required = [
        ...
        "_conclave/state/memory/preferences.md",
    ]
    for rel in required:
        p = root / rel
    ...
    for script in ["reindex_squads.py", "validate_conclave.py"]:
        p = root / "_conclave/tools/scripts" / script
