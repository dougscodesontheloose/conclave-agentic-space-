...
execution: inline
skills: ["trending-ad-hook-spotter"]
tasks:
...
- **Heurística Expandida:** Gerar imperativamente múltiplos arranjos do primeiro slide (*Hook*) para o usuário final selecionar o melhor.
- **Aprimoramento de Persona:** Aplicar um *Pacing Rhythm Analysis* evitando slides contíguos de densidade textualmente letárgica.
