...
execution: subagent
skills: ["create-html-carousel", "create-html-slides", "visual-brand-extractor"]
tasks:
...
- **Heurística Expandida:** Executar otimização de contraste autônoma visando compensar leitura em telas sob baixa luminosidade.
- **Aprimoramento de Persona:** Sintetizar as escolhas via um explicativo fixo de "Color Psychology Rationale" no artefato.
