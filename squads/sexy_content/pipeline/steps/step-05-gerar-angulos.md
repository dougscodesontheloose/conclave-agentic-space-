...
- `pipeline/data/tone-of-voice.md` — voz e estilo do Doug
...
4. Para cada ângulo: definir perspectiva, escrever o hook (primeira frase que para o scroll), esboçar a estrutura e justificar por que funciona para a voz do Doug.
...
**Por que funciona:** [raciocínio estratégico para a voz do Doug — 1-2 linhas]
...
**Por que funciona:** Doug opera com dado + narrativa. Esse ângulo respeita a inteligência do leitor e não pede que acredite — mostra o número.
...
**Estrutura:** Cita a frase → Explica as duas leituras possíveis → Apresenta a leitura do Doug → Termina com o que separa os dois grupos
...
**Por que funciona:** Contraintuitivo na dose certa — não nega o impacto, redireciona o que importa. É o tipo de post que o Doug assina com autoridade.
```
