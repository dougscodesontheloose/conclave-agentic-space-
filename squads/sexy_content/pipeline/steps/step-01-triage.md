---
type: checkpoint
outputFile: squads/sexy_content/output/triage.md
---

# Step 01: Triagem de Entrada
...
Salvar a escolha em `triage.md`:
- Se opção 1: `mode: reference` → ir para step-02 no modo "referência"
- Se opção 2: `mode: search` → ir para step-02 no modo "pesquisa"
