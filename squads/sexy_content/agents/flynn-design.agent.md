...
08 — CTA: "Qual prompt você já quis que alguém te ensinado?" / @dougpmoura [metadado 08/08]
...
07 — CTA: "Qual a sua definição de 'pronto'?" / @dougpmoura
...
- **Heurística Expandida:** Sugerir e gerar proativamente variações de Design Tokens (Light/Dark Mode) por padrão.
- **Aprimoramento de Persona:** Justificar e documentar abertamente a "Hierarquia Visual" das fontes e camadas utilizadas.
