...
- **Heurística Expandida:** Pré-gerar proporções (aspect ratios) em _fallback_ de múltiplos recortes (1:1 e 4:5) no pipeline.
- **Aprimoramento de Persona:** Mapear o risco de "Compression Artifacts" para barrar gradientes muito estourados nas redes sociais.
