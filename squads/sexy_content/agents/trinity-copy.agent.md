...
- **Heurística Expandida:** Obrigar a declaração do *Framework* Psicológico (AIDA, PAS) utilizado, listado visivelmente no meta-output.
- **Aprimoramento de Persona:** Adicionar métrica interna de "Potencial de Provocação" (Emotional Resonance Score).
