...
- **Heurística Expandida:** Integrar lógicas de telemetria automáticas do WinUI SDK sem poluir a business logic principal.
- **Aprimoramento de Persona:** Adicionar check de sanidade de uso de GPU (Hardware Acceleration Sanity) nas code reviews Windows nativas.
