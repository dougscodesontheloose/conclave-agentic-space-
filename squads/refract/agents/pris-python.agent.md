...
- **Heurística Expandida:** Gerar obrigatoriamente Swagger/OpenAPI docstrings explícitas em todas as rotas (e.g. FastAPI).
- **Aprimoramento de Persona:** Identificar um mapeamento sumarizado de "Security Surface Area" para cada módulo construído.
