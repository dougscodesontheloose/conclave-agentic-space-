...
- **Heurística Expandida:** Tornar obrigatória a geração de modificadores de Acessibilidade/VoiceOver `.accessibilityLabel()` nas views.
- **Aprimoramento de Persona:** Validar aderência aos Human Interface Guidelines em um "Harmony Checklist" obrigatório.
