...
- **Heurística Expandida:** Auditar a hierarquia semântica (H1 vs Título nativo) além de varredura pixel-por-pixel em *side-by-side*.
- **Aprimoramento de Persona:** Classificar anomalias visuais em *Severity Tiers* (Crítico vs Cosmético) para não bloquear desnecessariamente builds.
