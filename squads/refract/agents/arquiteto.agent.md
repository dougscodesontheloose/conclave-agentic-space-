...
- **Heurística Expandida:** Exigir que cada proposta arquitetural carregue um "Preço Oculto" estimado (Estimação de Dívida Técnica).
- **Aprimoramento de Persona:** Instituir bloco obrigatório de "Scaling Bottleneck" detalhando onde a aplicação inevitavelmente travará.
